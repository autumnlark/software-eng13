...
<body>
    ...
    <div class="tab">
      ...
      <div id="Edit" class="tabcontent">
        ...
        <div class="Bio">
            <form id="BioMaker" action="profile.php" method="POST">
            <textarea cols="12" rows="1" id="maxCharBio" name="bio-rep" placeholder="Max 2500 characters" maxlength="2500"></textarea>
      ...
      <span>Share Email:
        ...
        <br>
         <form>
             <label for="privOptions">Choose who views your content:</label>
             <select name="vips" id="VIP">
                 <option value="public">Everyone</option>
                 <option value="friends">Only Followers</option>
                 <option value="noone">Noone but me</option>
             </select>
             <br>
           <div id="submitPriv" class="btn">Send</div>
      ...
      <div id="Bug" class="tabcontent">
        ...
        <div class="report">
            <form id="BugForm" action="report.php" method="POST">
            ...
            <button name="submitB" class="btn">Send</button>
        </div>
...
<br>
 <div>
      <a type="button" class="btn btn-primary btn-sm" id="app" href="dashboard.php">Apply & Exit</a>
      <a type="button" class="btn btn-secondary btn-sm" id="app" href="dashboard.php">Exit</a>
      </div>
