...
///////////////////////////////////////
   ...
   /*Create a queryto be used*/
    $fetch_posts = "SELECT TOP 1 * FROM Posts WHERE post_type = 'Post' AND privacy = 'Public' ORDER BY points DESC";

     /*If the query is successful*/
    if  ($posts = $mysqli->query($fetch_posts)){
        /*If there are more than 0 results*/
        if ($posts->num_rows > 0){
            $post_data = $posts->fetch_object();
...
///////////////////////////////////////
 ...
 echo 'People:<br>';
   ...
   /*Create a queryto be used*/
    $fetch_people = "SELECT TOP 5 * FROM Users ORDER BY total_points DESC";
...
///////////////////////////////////////
   ...
   /*Create a queryto be used*/
    $fetch_challenges = "SELECT TOP 1 * FROM Posts WHERE post_type = 'Challenge' AND privacy = 'Public' ORDER BY points DESC";
    ...
    if  ($challenge = $mysqli->query($fetch_challenges)){
        ...
        if ($challenge->num_rows > 0){
            $challenges_data = $challenge->fetch_object()
                ...
                echo challenges_date->caption . "<br>";
