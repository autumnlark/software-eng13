...
<span><input id="back-btn" type="image" src="assets/back.png" name="backBtn" alt="Back" onclick="window.location.href='start.html'"></span>
...
?>
    ...
    <form action="login_action.php" method="post">
        ...
        <!-- Submit button -->
        <div class="flex-item">
            <button type="submit" class="submit-btn" role = "button">Log in</button>
        </div>
    </form>
    <br>
</div>
